...
const BASELINES: Record<string, BaselineTemplate> = {
  ...
  '12:3': {
    ...
    rounds: [
      ...
      { matches: [[[0,3], [4,6], 0], [[1,11], [7,9], 1], [[2,8], [5,10], 2]], sitOuts: [] },
      { matches: [[[0,6], [2,7], 1], [[1,5], [3,11], 0], [[4,9], [8,10], 2]], sitOuts: [] },
      { matches: [[[0,2], [1,3], 2], [[4,10], [7,11], 1], [[5,8], [6,9], 0]], sitOuts: [] },
      { matches: [[[0,4], [1,8], 1], [[2,6], [9,11], 2], [[3,5], [7,10], 0]], sitOuts: [] },
      { matches: [[[0,7], [9,10], 2], [[1,2], [6,8], 0], [[3,4], [5,11], 1]], sitOuts: [] },
      { matches: [[[0,8], [5,7], 1], [[1,6], [3,9], 2], [[2,10], [4,11], 0]], sitOuts: [] },
      { matches: [[[0,5], [2,4], 2], [[1,9], [3,10], 1], [[6,11], [7,8], 0]], sitOuts: [] },
      { matches: [[[0,10], [3,6], 0], [[1,7], [4,8], 2], [[2,11], [5,9], 1]], sitOuts: [] },
      { matches: [[[0,9], [1,4], 0], [[2,5], [3,7], 2], [[6,10], [8,11], 1]], sitOuts: [] },
    ],
  },
  '16:4': {
    players: 16,
