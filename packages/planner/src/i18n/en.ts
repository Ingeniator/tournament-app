...
const en: Translations = {
  ...
  'organizer.mixicanoDesc': 'Mixicano \u2014 Like Mexicano, but teams are always mixed (one male + one female).',
  'organizer.kotcDesc': 'King of the Court \u2014 Courts are ranked. Winners move up, losers move down. Bonus points on top courts.',
  'organizer.courtSubname': 'Subname',
