...
const sr: Translations = {
  ...
  'organizer.playersCount': 'Igrači ({count})',
  ...
  'organizer.removeLink': 'Ukloni Telegram',
  ...
  'organizer.setsPerMatch': 'Setova po meču',
  ...
  'organizer.recommendedSets': 'Maks: {sets} setova po meču',
  ...
  'organizer.setsSuggestion': '{sets} setova po me\u010du ili ',
  'organizer.gamesSuggestion': '{games} gemova po me\u010du ili ',
  'organizer.timedSuggestion': '{rounds} rundi \u00d7 {minutes} min',
  'organizer.recommendedTimedPair': 'Preporu\u010deno: {rounds} rundi \u00d7 {minutes} min',
  ...
  'organizer.captainUnapproved': '{count} igrač(a) čeka odobrenje kapitena. Postavite sebe kao kapitena ili podelite link kapitena da odobrite postave.',
  ...
  'join.copied': 'Kopirano u klipbord',
  'join.exportPairs': 'Kopiraj parove',
  ...
  'join.partnerLabel': 'Željeni partner',
  'join.partnerName': 'Ime partnera',
  'join.partnerTelegram': 'Telegram partnera (opciono)',
  'join.partnerTaken': '{name} je već uparen sa drugim igračem',
  ...
  'join.captainUnassigned': 'Nije dodeljen',
  'join.approve': 'Odobri',
  'join.reject': 'Odbij',
